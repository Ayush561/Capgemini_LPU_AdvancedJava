...
public class UserServiceTest {
    ...
    @Mock
    UserDao daomock;  //Either we can do this or we can do do UserDao dao = mock(UserDao.class); But this annotation is used in industry
    ...
    public void testUserType() {
        ...
        String res2 = service.typeOfUser(2);
        
        assertEquals("New user", res1); 
        assertEquals("Regular user", res2);
    }
}
